					...
					<div class="m-portlet__head-tools">
											<ul class="m-portlet__nav">
												<li class="m-portlet__nav-item">
													<form class="m-form m-form--fit m-form--label-align-right"  action="afficher-campagne.php" method="post">';
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['IdCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['NomCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['VilleCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['AuteurCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['IdCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars($donnees['DemandeurCampagne']) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars(date("d-m-Y",strtotime($donnees['DebutCampagne']))) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars(date("d-m-Y",strtotime($donnees['FinCampagne']))) . '">'; ?>
														<?php echo '<input type="hidden" name="IdCampagne" value="'. htmlspecialchars(date("d-m-Y",strtotime($donnees['DateModif']))) . '">'; ?>

														<?php echo	'<button type="submit" name="NomCampagne" class="btn btn-outline-secondary m-btn m-btn--icon " value="'. htmlspecialchars($donnees['NomCampagne']) . '"><i class="fa flaticon-settings"></i>		Modifier Campagne</button> </button>';?>
