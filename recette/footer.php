		...
		<script src="vendors2/datatables.net/js/jquery.dataTables.js"></script>


	    <script src="vendors2/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
	    	<!--<script src="vendors2/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
	    <script src="vendors2/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
			-->
	    <script src="vendors2/jszip/dist/jszip.min.js"></script>
	    <script src="vendors2/pdfmake/build/pdfmake.min.js"></script>
	    <script src="vendors2/pdfmake/build/vfs_fonts.js"></script>
	    <script src="vendors2/datatables.net-buttons/js/buttons.html5.min.js"></script>
	    <script src="vendors2/datatables.net-buttons/js/buttons.print.min.js"></script>
	    <script src="vendors2/datatables.net-buttons/js/buttons.colVis.min.js"></script>
	    <script src="assets2/js/init-scripts/data-table/datatables-init.js"></script>
		...
		<script src="assets/app/js/chartjs-plugin-labels.js" type="text/javascript"></script>
		<script src="assets/app/js/dashboard.js" type="text/javascript"></script>
		<script src="assets/app/js/canvasjs.min.js" type="text/javascript"></script>
