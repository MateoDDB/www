...
<html lang="fr">
	...
	<head>
		<meta charset="utf-8" />
		<title>Créative Bus | Enregistrement</title>
					...
					<center>
						<a href="accueil.php">
							<div class="m-login__form-action">
								...
								<button type="submit" class="btn btn-outline-focus m-btn m-btn--pill m-btn--custom  m-login__btn">Accueil</button>
									
							</div>
						</a>
					</center>
					<p class="m-error_title m--font-light">
						Vous avez réussie à inscrire un <br> nouveau profil.
					</p>
					<p class="m-error_subtitle">
						Un e-mail sera envoyé à ce dernier <br> pour finaliser son inscription.
					</p>
