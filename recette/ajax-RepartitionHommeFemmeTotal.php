...
$tableau2=array(
	array(
		'label' => 'Creation - Hommes' ,'nb' => $NbrHommeCreation ,
	),

	array(
		'label' => 'Emploi - Hommes' ,'nb' => $NbrHommeEmploi ,
	),
	array(
		'label' => 'Creation - Femmes' ,'nb' => $NbrFemmeCreation ,
	),
	array(
		'label' => 'Emploi - Femmes' ,'nb' => $NbrFemmeEmploi ,
	),
);
echo json_encode($tableau2,JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE);
