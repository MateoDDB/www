            ...
            form.ajaxSubmit({
                ...
                success: function(response, status, xhr, $form) {
                	...
                	setTimeout(function() {
	                    ...
	                    showErrorMsg(signInForm, 'success', 'Nous vous remercions. Pour compléter votre inscription, veuillez vérifier votre email.');
	                }, 2000);
                }
            });
        });
            ...
            form.ajaxSubmit({
                ...
                success: function(response, status, xhr, $form) { 
                	...
                	setTimeout(function() {
	                    ...
	                    showErrorMsg(signInForm, 'success', 'Cool! Une instruction de récupération de mot de passe a été envoyée à votre adresse email.');
                	}, 2000);
                }
            });
        });
