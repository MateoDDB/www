...
<?php
	...
	if(isset($_POST['NomCampagne'])){
	   $tabU = $conn->query ('Select * from SaisieCreation_Recette where Campagne="'.$_POST['NomCampagne'].'"');
	}
else {
									...
									<div class="m-portlet__head-caption">
										<div class="m-portlet__head-title">
											<h3 class="m-portlet__head-text">
												Liste des fiches Création de la Campagne : <?php echo $_POST['NomCampagne']; ?>
											</h3>
										</div>
									</div>
