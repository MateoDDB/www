...
/*if ($Signature!="")
	...
	if ($Projet!="" || $StadeProjet!="" || $SituationDuBeneficiaire!="" || $EtesVousAccompagne!="" || $SouhaitezVousEtreRecontacte!="" || $Prenom!="" || $Nom!="" || $Prenom!="" || $Telephone_1!="" || $Sexe!="" || $LieuBus!="")
	{
						...
						$dm = $conn->query ('insert into SaisieCreation_Recette(Projet, StadeProjet, ComStadeProjet, ExpCreation, ExpProEtFor,
						FreinsRencontres, SituationDuBeneficiaire, NiveauEtude, EtesVousAccompagne, SiOuiQui, SouhaitezVousEtreRecontacte, Nom, Prenom, Sexe, DateDeNaissance, NumeroRue, NomRue, Ville, CodePostal, Quartier, Telephone_1, Telephone_2, email, Signature, LieuBus, DateBus, StructureConseiller, InfoCom, CommentaireInfoCom, OrientationCreation, QuelSuivi, Campagne)
						...
						"'.$DateDeNaissance.'", "'.$NumeroRue.'","'.$NomRue.'","'.$Ville.'","'.$CodePostal.'","'.$Quartier.'","'.$Telephone_1.'","'.$Telephone_2.'","'.$email.'","'.$Signature.'","'.$LieuBus.'",NOW(),"'.$StructureConseiller.'",
						"'.$InfoCom.'","'.$CommentaireInfoCom.'","'.$OrientationCreation.'","'.$QuelSuivi.'","'.$Campagne.'")');
