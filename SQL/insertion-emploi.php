...
<?php
	...
	if ($Projet!="" || $RechercheEmploi!="" || $RechercheFormation!="" || $SituationAujourdhui!="" || $Nom!="" || $Prenom!="" || $Telephone_1!="" || $Sexe!="" || $LieuBus!="")
	{
						...
						mysqli_set_charset($conn, "utf8");
								...
								Signature, LieuBus, DateBus, StructureConseiller, InfoCom, OrientationEmploi, QuelSuivi, Campagne) values ("'.$Projet.'", "'.$NomProjet.'", "'.$RechercheEmploi.'", "'.$RechercheFormation.'","'.$SecteurActivite.'","'.$ExpProfessionnelle.'", "'.$NiveauEtude.'", "'.$Diplome.'", "'.$ContraintesOuBesoins.'", "'.$SituationAujourdhui.'",
								"'.$EtesVousAccompagneParStructure.'", "'.$SouhaitezVousEtreRecontacte.'", "'.$ReponseAccompagneParStructure.'",
								"'.$ComReponseAccompagneParStructure.'","'.$Nom.'","'.$Prenom.'","'.$Sexe.'","'.$DateNaissance.'","'.$NumeroRue.'","'.$NomRue.'","'.$Ville.'","'.$CodePostal.'","'.$Quartier.'","'.$Telephone_1.'","'.$Telephone_2.'","'.$email.'","'.$Signature.'","'.$LieuBus.'",NOW(),"'.$StructureConseiller.'","'.$InfoCom.'","'.$OrientationEmploi.'","'.$QuelSuivi.'","'.$Campagne.'")');
