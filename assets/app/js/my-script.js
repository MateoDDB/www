...
{
  function testQuestion(objet,value,NbParent){
  ...
  testQuestion(Signature,"Signature",2);
  testQuestion(LieuBus,"LieuBus",1);
  testQuestion(Telephone_1,"Telephone_1",1);
  testQuestion(Sexe,"Sexe",1);
  testQuestion(Prenom,"Prenom",1);
  testQuestion(Nom,"Nom",1);
  testQuestion(SituationAujourdhui,"SituationAujourdhui",1);
  testQuestion(RechercheFormation,"RechercheFormation",1);
  testQuestion(RechercheEmploi,"RechercheEmploi",1);
        ...
        success: function(res){
          ...
          var chartdata = {
            ...
            datasets : [
              {
                label : 'Nombre',
                backgroundColor: ["#0984e3","#74b9ff","#e84393", "#fd79a8","#3cba9f"],
                data : nb
              }
            ]
          }
