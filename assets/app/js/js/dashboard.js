...
var revenueChange = function() {
  ...
  type: 'doughnut',
  data: {
  labels: ["Creation - Hommes", "Creation - Femmes", "Emploi - Hommes", "Emploi - Femmes"],
  datasets: [
  {
      ...
      $.ajax(
        {
          ...
          success: function(res){
            ...
            for(var i in res){
              ...
              nbFormulaire.push(parseInt(nbFormulaireEmploi[nbFormulaireEmploi.length - 1]) + parseInt(nbFormulaireCreation[nbFormulaireCreation.length - 1]));
              window.alert(parseInt(nbFormulaireCreation[nbFormulaireCreation.length - 1])  );
            }
