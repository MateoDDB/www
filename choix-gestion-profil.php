...
<?php include("header.php"); ?>
						...
						<div class="m-portlet">
							...
							<center><div class="m-portlet__body">
									...
									<div class="m-pricing-table-1__items row">
										...
										<div class="m-pricing-table-1__item col-lg-3">
											<div class="m-pricing-table-1__visual">
												...
												<span class="m-pricing-table-1__icon m--font-accent"><i class="fa flaticon-add"></i></span>
												<!-- /Applications/MAMP/htdocs/Créative-Bus-DevCusto/vendors/vendors/flaticon/css  -->
											</div>
											<span class="m-pricing-table-1__price">Ajouter</span>
											<h2 class="m-pricing-table-1__subtitle">Inscrire un <br> nouveau profil</h2>
											...
											<div class="m-pricing-table-1__visual">
												<div class="m-pricing-table-1__hexagon1"></div>
												<div class="m-pricing-table-1__hexagon2"></div>
												<span class="m-pricing-table-1__icon m--font-focus"><i class="fa flaticon-settings"></i></span>
											</div>
											<span class="m-pricing-table-1__price">Modif/Supp</span>
											<h2 class="m-pricing-table-1__subtitle">Modifier ou supprimer un <br> profil</h2>
											<a href="modifier-supprimer-profil.php">
											<div class="m-pricing-table-1__btn">
