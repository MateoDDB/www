<?php
	...
	if ($_POST){
		...
		if($dn['password']==$password && $dn>0)
		{
			...
			$_SESSION['IdUsers'] = $dn['IdUsers'];
			$_SESSION['UserName'] = $dn['UserName'];
			$_SESSION['profil'] = $dn['profil'];
			header('Location: accueil.php'); // @Jean-Malek : pourquoi on a mis en paramétre GET l'IdUsers ?
			exit();
		...
		else
		{
			...
			$messageNc = "L'adresse mail ou le mot de passe n'est pas correct, Veuillez resaisir.";
					...
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="index.php" method="post">
								...
								<div class="form-group m-form__group">
									<input class="form-control m-input m-login__form-input--last" type="password" maxlength="250"  placeholder="Mot de passe" name="password">
								</div>
								<div class="row m-login__form-sub">
									...
									<div class="col m--align-right m-login__form-right">
										<a href="password-oublie.php"  class="m-link">Mot de passe oublié ?</a>
									</div>
								</div>
								<div class="m-login__form-action">
									<button type="submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary">Connexion</button>
								</div>
							</form>
						</div>
